...
/**
 * 首页：功能入口（六级学习 / 全书学习 / AI 识图解题 / 学习统计 / 设置 / 关于）+ 底部我的目标
 */
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.cardStudyHub.setOnClickListener {
            startActivity(Intent(this, StudyHubActivity::class.java))
        }
        binding.cardTextbook.setOnClickListener {
            startActivity(Intent(this, TextbookListActivity::class.java))
        }
