...
> 📦 **直接下载安装**：[GitHub Releases v1.7](https://github.com/FZZZZZZZZZ19/XueTi/releases/tag/v1.7)（`XueTi-v1.7-debug.apk`，Debug 签名，手机下载后直接安装）
...
`apk/XueTi-v1.7-debug.apk`（Debug 签名，直接安装到手机）

```bash
adb install -r apk/XueTi-v1.7-debug.apk
```
