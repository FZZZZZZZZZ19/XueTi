...
一款简洁的**英语学习 App**。v1.4 版本包含：六级单词每日学习（内置完整六级词库 6662 词）、**AI 识图解题（可裁剪 + 图像增强）**、**学习统计与日历自定义目标**，以及外观定制、应用内更新与每日提醒。

> 📦 **直接下载安装**：[GitHub Releases v1.4](https://github.com/FZZZZZZZZZ19/XueTi/releases/tag/v1.4)（`XueTi-v1.4-debug.apk`，Debug 签名，手机下载后直接安装）
...
| **学习统计 + 日历**（v1.4） | 今日已学 / 连续打卡 / 累计已学 / 认识率概览；近 7 天柱状图；**学习日历**（可翻月，标注每天学习数量与达标状态）；**点击日期可自定义该日学习目标**（跟随默认 / 休息日 / 5·10·20·30·50 词）；今日学习内容逐词列表 |
...
`apk/XueTi-v1.4-debug.apk`（Debug 签名，直接安装到手机）

```bash
adb install -r apk/XueTi-v1.4-debug.apk
```
